...
<head> 
    <title>Dreadlocks and weave spa HTML Template Live Demo</title>
    <meta name="Keywords">
...
<div class="page-preview">
    ...
    <div class="page-preview-header">
        ...
        <a class="close" href="/ht/3125838/dreadlocks-and-weave-spa-html-template"><img alt="Close" src="//csite.nicepage.com/Images/Site/icon-close.png"></a>
    </div>
    <div class="page-preview-body">
        <iframe id="livePreviewFrame" src="https://website3125827.nicepage.io/Home.html?version=0eeba34d-d5a9-4fba-bb3a-eae8fd52919b" width="1057" height="640" style="width:100%;"></iframe>
    </div>
</div>
